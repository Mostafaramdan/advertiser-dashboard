...
const permissions = computed(() => ({
  create: hasPermission('create_ticket_type'),
  edit: hasPermission('update_ticket_type'),
  delete: hasPermission('delete_ticket_type'),
  changeStatus: hasPermission('change_status_ticket_type'),
  sort: hasPermission('sort_support_ticket_type'),
}))
...
<template>
  ...
  <VCard title="أنواع التذاكر / موظفي الدعم" class="page-card">
    <VCardText>
      <PageActions
