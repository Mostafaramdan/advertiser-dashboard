...
const permissions = computed(() => ({
  ...
  viewAdBlockDetails: hasPermission('view_advertiser_block_details'),
}))
...
<template>
  <section>
    <NotificationModal
      ...
      :user="activeUser"
    />
    <VCard title="حظر عرض الاعلانات" class="page-card">
      <VCardText>
        <PageActions
