...
import AdSpacesPaymentMethodCard from '../../components/AdSpacesPaymentMethodCard.vue'
import type { PaymentGetWay, PaymentMethod } from '../../interfaces/PlatformDetails'
import AdSpacesPaymentMethodFormModal from '../../modals/AdSpacesPaymentMethodFormModal.vue'
import { adSpacesPlatformService } from '../../services/AdSpacesPlatformService'
...
const permissions = computed(() => ({
  create: hasPermission('offers_create_billing_card'),
}))
...
<template>
  <div v-loading="isLoading.data" class="payments-methods">
    ...
    <AdSpacesPaymentMethodFormModal
      v-if="showFormModal"
