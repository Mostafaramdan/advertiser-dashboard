...
import AdSpacesPlatformDetailsCard from '../../components/AdSpacesPlatformDetailsCard.vue'
...
const permissions = computed(() => ({
  edit: hasPermission('offers_update_general_settings'),
}))
...
<template>
  <section class="platform-settings-details">
    ...
    <VCard v-loading="isLoading.data" flat :disabled="!permissions.edit">
      <AdSpacesPlatformDetailsCard :platform-data="platformData" />
