...
import AdSpacesReadyReplyDetailsModal from '../modals/AdSpacesReadyReplyDetailsModal.vue'
import AdSpacesReadyReplyFormModal from '../modals/AdSpacesReadyReplyFormModal.vue'
import { adSpacesReadyRepliesService } from '../services/AdSpacesReadyRepliesService'
...
const {
  ...
  sortItems,
} = UseCrudHelpers<ReadyReply>(adSpacesReadyRepliesService, params, MODEL_NAME)
...
const permissions = computed(() => ({
  create: hasPermission('ad_spaces_create_admin_reply'),
  edit: hasPermission('ad_spaces_update_admin_reply'),
  delete: hasPermission('ad_spaces_delete_admin_reply'),
  changeStatus: hasPermission('ad_spaces_change_status_admin_reply'),
  sort: hasPermission('ad_spaces_sort_admin_reply'),
}))
...
<template>
  <section>
    ...
    />
    <AdSpacesReadyReplyDetailsModal
