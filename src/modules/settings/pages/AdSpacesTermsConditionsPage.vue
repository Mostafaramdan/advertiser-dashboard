...
import AdSpacesTermsConditionsDetailsModal from '../modals/AdSpacesTermsConditionsDetailsModal.vue'
import AdSpacesTermsConditionsFormModal from '../modals/AdSpacesTermsConditionsFormModal.vue'
...
const {
  ...
  sortItems,
} = UseCrudHelpers<TermsConditionsItem>(adSpacesTermsConditionsService, params, MODEL_NAME)
...
const permissions = computed(() => ({
  create: hasPermission('ad_spaces_create_term'),
  edit: hasPermission('ad_spaces_update_term'),
  delete: hasPermission('ad_spaces_delete_term'),
  changeStatus: hasPermission('ad_spaces_change_status_term'),
  sort: hasPermission('ad_spaces_sort_term'),
}))
...
<template>
  <section>
    ...
    <AdSpacesTermsConditionsFormModal
      v-if="showFormModal"
    ...
    />
    <AdSpacesTermsConditionsDetailsModal
