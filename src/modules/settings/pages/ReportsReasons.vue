...
const permissions = computed(() => ({
  create: hasPermission('create_report_reason'),
  edit: hasPermission('update_report_reason'),
  delete: hasPermission('delete_report_reason'),
  changeStatus: hasPermission('change_status_report_reason'),
  sort: hasPermission('sort_report_reason'),
}))
