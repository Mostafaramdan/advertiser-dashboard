...
const permissions = computed(() => ({
  create: hasPermission('create_admin_reply'),
  edit: hasPermission('update_admin_reply'),
  delete: hasPermission('delete_admin_reply'),
  changeStatus: hasPermission('change_status_admin_reply'),
  sort: hasPermission('sort_admin_reply'),
}))
        ...
        >
          ...
          <template #item.types="{ item }">
            <div class="d-flex gap-2">
              <VChip
                v-for="type in item.raw.types as unknown"
                :key="type"
                variant="outlined"
                color="primary"
                label
