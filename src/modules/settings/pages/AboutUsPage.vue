...
import AboutUsDetailsModal from '../modals/AboutUsDetailsModal.vue'
import AboutUsFormModal from '../modals/AboutUsFormModal.vue'
...
const {
  ...
  sortItems,
} = UseCrudHelpers<AboutUsItem>(aboutUsService, params, MODEL_NAME)
...
const permissions = computed(() => ({
  create: hasPermission('create_about'),
  edit: hasPermission('update_about'),
  delete: hasPermission('delete_about'),
  changeStatus: hasPermission('change_status_about'),
  sort: hasPermission('sort_about'),
}))
...
<template>
  <section>
    ...
    />
    <AboutUsDetailsModal v-if="showDetailsModal" v-model:showModal="showDetailsModal" :active-item="activeItem" />
