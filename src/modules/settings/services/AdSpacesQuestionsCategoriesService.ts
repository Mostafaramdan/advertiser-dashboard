...
class AdSpacesQuestionsCategoriesService {
  contextPath = 'ad_spaces_support_categories'
...
export const adSpacesQuestionsCategoriesService = new AdSpacesQuestionsCategoriesService()
