...
const permissions = computed(() => ({
  edit: hasPermission('ad_spaces_update_billing_card'),
  delete: hasPermission('ad_spaces_delete_billing_card'),
  changeStatus: hasPermission('ad_spaces_change_status_billing_card'),
}))
