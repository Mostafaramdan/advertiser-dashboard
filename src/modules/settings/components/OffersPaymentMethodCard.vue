...
const permissions = computed(() => ({
  edit: hasPermission('offers_update_billing_card'),
  delete: hasPermission('offers_delete_billing_card'),
  changeStatus: hasPermission('offers_change_status_billing_card'),
}))
