...
const emit = defineEmits<{
  ...
  (e: 'createItem', value: SubscriptionExtraPoint): void
  (e: 'editItem', value: SubscriptionExtraPoint): void
}>()
...
const formTitle = computed(() => {
  return props.formAction === 'create'
    ? 'اضافة بند'
    : props.formAction === 'edit' ? 'تعديل بند' : 'عرض بند'
})
...
// #endregion
function edit() {
  subscriptionExtraPointsService.editItem(formData).then(res => {
...
function create() {
  subscriptionExtraPointsService.createItem(formData).then(res => {
    toast.success(res.data.message)
