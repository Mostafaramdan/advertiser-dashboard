...
const emit = defineEmits<{
  ...
  (e: 'createItem', value: AboutUsItem): void
  (e: 'editItem', value: AboutUsItem): void
}>()
...
const formTitle = computed(() => {
  return props.formAction === 'create'
    ? 'اضافة موضوع'
    : props.formAction === 'edit' ? 'تعديل موضوع' : 'عرض موضوع'
})
...
function getItemDetails(id: any) {
  isLoading.data = true
  aboutUsService.getSingleItem(id).then(res => {
...
function edit() {
  aboutUsService.editItem(formData).then(res => {
...
function create() {
  aboutUsService.createItem(formData).then(res => {
    toast.success(res.data.message)
