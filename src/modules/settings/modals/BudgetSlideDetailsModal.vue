...
<template>
  <VDialog v-model="showModal" max-width="600" scrollable class="details-modal">
    ...
    <VCard>
      <div>
        <VCard v-if="activeItem" title="عرض شريجة">
          <VCardText>
            <VList :lines="false">
              <VListItem
              ...
              <VListItem class="px-2 py-2" title="من" :subtitle="activeItem.from" border />
              <VListItem class="px-2 py-2" title="الى" :subtitle="activeItem.to" border />
            </VList>
