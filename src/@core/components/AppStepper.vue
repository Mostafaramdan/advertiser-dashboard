      ...
      >
        ...
        <template v-else>
          <div class="d-flex align-center gap-x-2">
            <div class="d-flex align-center gap-2">
              ...
              >
                ...
                <template v-if="index >= currentStep">
                  ...
                  <VIcon v-else icon="tabler-alert-circle" size="24" color="error" />
                </template>

                <!-- 👉 step completed icon -->

                <VIcon v-else icon="custom-check-circle" class="stepper-step-icon" size="24" />
              </div>
            ...
            <!-- 👉 stepper step line -->
            <div v-if="isHorizontalAndNotLastStep(index)" class="stepper-step-line" />
          </div>
        </template>
        <!-- !SECTION  -->
      </div>
