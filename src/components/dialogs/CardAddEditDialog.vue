      ...
      <VCardText class="pt-6">
        <VForm @submit.prevent="() => {}">
          <VRow>
            <!-- 👉 Card Number -->
            <VCol cols="12">
              <AppTextField v-model="cardDetails.number" label="Card Number" type="number" />
            </VCol>

            <!-- 👉 Card Name -->
            <VCol cols="12" md="6">
              <AppTextField v-model="cardDetails.name" label="Name" />
            </VCol>

            <!-- 👉 Card Expiry -->
            <VCol cols="6" md="3">
              <AppTextField v-model="cardDetails.expiry" label="Expiry" />
            </VCol>

            <!-- 👉 Card CVV -->
            <VCol cols="6" md="3">
              <AppTextField v-model="cardDetails.cvv" type="number" label="CVV" />
            </VCol>
            ...
            <VCol cols="12" class="text-center">
              <VBtn class="me-3" type="submit" @click="formSubmit"> Submit </VBtn>
              <VBtn
                color="secondary"
                variant="tonal"
