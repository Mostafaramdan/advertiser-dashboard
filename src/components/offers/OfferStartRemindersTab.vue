...
import type { OfferStartReminder, User } from '@/interfaces/Offer'
...
const tableData = ref<OfferStartReminder[]>([])
const metaData = ref<MetaData | null>(null)
const isLoadingData = ref<boolean>(false)
const showNotificationModal = ref<boolean>(false)
const showDetailsModal = ref<boolean>(false)
const activeUser = ref<User | null>(null)
const activeItem: Ref<OfferStartReminder | null> = ref(null)
...
function getPageData(): void {
  ...
  offersService
    .getOfferStartReminders(offerId, params)
    .then((res: any) => {
...
function DetailsModal(item: OfferStartReminder): void {
